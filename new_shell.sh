...
wget --no-check-certificate https://raw.githubusercontent.com/nibbler777/shell/master/.vimrc -O ~/.vimrc
echo "Downloading and replacing ~/.zshrc..."
wget --no-check-certificate https://raw.githubusercontent.com/nibbler777/shell/master/.zshrc -O ~/.zshrc
echo "Creating vim colors dir and downloading vim colors..."
mkdir -p ~/.vim/colors
wget --no-check-certificate https://raw.githubusercontent.com/nibbler777/shell/master/.vimrc -O ~/.vim/colors/wombat256mod.vim
